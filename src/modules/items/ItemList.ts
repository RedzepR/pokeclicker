...
// Not sold in shops
ItemList.Fastball = new PokeballItem(Pokeball.Fastball, 500, Currency.farmPoint, { visible: new MaxRegionRequirement(Region.unova) }, 'Fast Ball');
ItemList.Quickball = new PokeballItem(Pokeball.Quickball, 750000, Currency.dungeonToken, { visible: new MaxRegionRequirement(Region.alola) }, 'Quick Ball');
ItemList.Timerball = new PokeballItem(Pokeball.Timerball, 750000, Currency.dungeonToken, { visible: new MaxRegionRequirement(Region.kalos) }, 'Timer Ball');
ItemList.Duskball = new PokeballItem(Pokeball.Duskball, 5000, Currency.questPoint, { visible: new MaxRegionRequirement(Region.alola) }, 'Dusk Ball');
ItemList.Luxuryball = new PokeballItem(Pokeball.Luxuryball, 50, Currency.battlePoint, { visible: new MaxRegionRequirement(Region.kalos) }, 'Luxury Ball');
ItemList.Diveball = new PokeballItem(Pokeball.Diveball, 1000, Currency.diamond, { visible: new MaxRegionRequirement(Region.kalos) }, 'Dive Ball');
ItemList.Lureball = new PokeballItem(Pokeball.Lureball, 1000, Currency.diamond, { visible: new MaxRegionRequirement(Region.unova) }, 'Lure Ball');
ItemList.Nestball = new PokeballItem(Pokeball.Nestball, 500, Currency.farmPoint, { visible: new MaxRegionRequirement(Region.kalos) }, 'Nest Ball');
ItemList.Repeatball = new PokeballItem(Pokeball.Repeatball, Infinity, Currency.battlePoint, undefined, 'Repeat Ball');
ItemList.Beastball = new PokeballItem(Pokeball.Beastball, 1000, Currency.questPoint, undefined, 'Beast Ball');
ItemList.Moonball = new PokeballItem(Pokeball.Moonball, 500, Currency.farmPoint, { visible: new MaxRegionRequirement(Region.unova) }, 'Moon Ball');
ItemList.Netball = new PokeballItem(Pokeball.Netball, 500, Currency.farmPoint, { visible: new MaxRegionRequirement(Region.kalos) }, 'Net Ball');
