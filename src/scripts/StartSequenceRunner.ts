class StartSequenceRunner {
    ...
    public static pickStarter(s: GameConstants.Starter) {
        ...
        const battlePokemon = new BattlePokemon(dataPokemon.name, dataPokemon.id, dataPokemon.type1, dataPokemon.type2, 10, 1, 100, 0, new Amount(0, GameConstants.Currency.money), shiny, 0, gender, GameConstants.ShadowStatus.None, false, EncounterType.route);
