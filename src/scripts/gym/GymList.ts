...
GymList['Cipher Admin Ein'] = new Gym (
    ...
    undefined, undefined, { displayName: 'Challenge Ein', doubleBattle: true }
);
GymList['Cipher Admin Miror B.'] = new Gym (
    ...
    [new QuestLineCompletedRequirement('Shadows in the Desert')],
    undefined, undefined, { displayName: 'Challenge Miror B.', doubleBattle: true }
);
GymList['Cipher Admin Dakim'] = new Gym (
    ...
    [new QuestLineCompletedRequirement('Shadows in the Desert')],
    undefined, undefined, { displayName: 'Challenge Dakim', doubleBattle: true }
);
GymList['Cipher Admin Venus'] = new Gym (
    ...
    [new QuestLineCompletedRequirement('Shadows in the Desert')],
    undefined, undefined, { displayName: 'Challenge Venus', doubleBattle: true }
);
GymList['Cipher Admin Lovrina'] = new Gym ( //Kalos E4 difficulty, plus 10% per Orre Colosseum boss
    ...
    undefined, undefined, { displayName: 'Challenge Lovrina', doubleBattle: true }
);
GymList['Cipher Admin Snattle'] = new Gym (
    ...
    undefined, undefined, { displayName: 'Challenge Snattle', doubleBattle: true }
);
GymList['Cipher Admin Gorigan'] = new Gym (
    ...
    undefined, undefined, { displayName: 'Challenge Gorigan', doubleBattle: true }
);
GymList['Cipher Admin Ardos'] = new Gym (
    ...
    undefined, undefined, { displayName: 'Challenge Ardos', doubleBattle: true }
);
GymList['Cipher Admin Eldes'] = new Gym (
    ...
    undefined, undefined, { displayName: 'Challenge Eldes', doubleBattle: true }
);
//Sinnoh Gyms
