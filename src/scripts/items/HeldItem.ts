...
ItemList.Black_Glasses = new TypeRestrictedExceptionAttackBonusHeldItem('Black_Glasses', 10000, GameConstants.Currency.money, undefined, 'Black Glasses', 1.2, PokemonType.Dark, GameConstants.Region.johto, { Squirtle: true, 'Squad Leader Squirtle': false, 'Squirtle Squad': false, 'Squad Leader Wartortle': false, 'Blastoise (Firefighter)': false });
