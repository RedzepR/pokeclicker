...
dungeonList['Mt. Pyre'] = new Dungeon('Mt. Pyre',
    [
        ...
        new DungeonTrainer('Young Couple',
            ...
            { weight: 1, doubleBattle: true  }, 'Dez & Luke'),
        new DungeonTrainer('Psychic',
            [
...
dungeonList['Phenac City Battles'] = new Dungeon('Phenac City Battles',
    [
        new DungeonTrainer('Miror B. Peon',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(25, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less)}, 'Folly', '(folly)'),
...
dungeonList['Deep Colosseum'] = new Dungeon('Deep Colosseum',
    ...
    [
        new DungeonTrainer('Deep King',
            ...
            ], { weight: 1, doubleBattle: true }, 'Agnol', '(angol)'),
    ],
    88800, 134);
...
dungeonList['Iron Island'] = new Dungeon('Iron Island',
    ...
    [
        new DungeonTrainer('Galactic Grunts',
            ...
            ], { weight: 1, doubleBattle: true  }, undefined, '(male)'),
    ],
    66500, 218,
    () => {
        BagHandler.gainItem({type: ItemType.item, id: 'Fighting_egg'}, 1);
...
dungeonList['Malie Garden'] = new Dungeon('Malie Garden',
    [
        ...
        new DungeonTrainer('Tourist Couple',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Child of the Stars', 2) }, 'Landon and Yuriko'),
    ],
    {
        common: [
            {loot: 'xClick'},
    ...
    [
        ...
        new DungeonTrainer('Tourist Couple',
            ...
            { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineStepCompletedRequirement('Child of the Stars', 2, GameConstants.AchievementOption.less) }, 'Landon and Yuriko'),
...
dungeonList['Galar Mine No. 2'] = new Dungeon('Galar Mine No. 2',
    [
        ...
        new DungeonTrainer('Team Yell Grunts',
            ...
            { weight: 1, doubleBattle: true  }, undefined),
