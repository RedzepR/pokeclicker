...
class AchievementHandler {
    ...
    public static initialize(multiplier: Multiplier, challenges: Challenges) {
        ...
        AchievementHandler.addAchievement('Who Planted These Here?', 'Unlock 8 Berries.', new TotalBerriesUnlockedRequirement(8), 0.1);
        AchievementHandler.addAchievement('Farmer in Training', 'Unlock 18 Berries.', new TotalBerriesUnlockedRequirement(18), 0.2);
        AchievementHandler.addAchievement('Farming Apprentice', 'Unlock 36 Berries.', new TotalBerriesUnlockedRequirement(36), 0.3);
        AchievementHandler.addAchievement('Master Farmer', 'Unlock all 69 Berries.', new TotalBerriesUnlockedRequirement(69), 0.4);
        ...
        AchievementHandler.addAchievement('Alphabet Soup for Ruin Maniac', 'Catch all unique Unown forms.', new CaughtUniquePokemonByFilterRequirement(unownDexFilter, 'Catch all unique Unown forms.', unownAmount), 0.25);
        AchievementHandler.addAchievement('"I am the Alpha and the Omega"', 'Catch all unique Shiny Unown forms.', new CaughtUniquePokemonByFilterRequirement(unownDexFilter, 'Catch all unique Unown forms.', unownAmount, true), 0.5);
